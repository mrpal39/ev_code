...
from webdev.utils import  cache_decorator,parse_dict_to_url
...
class BaseOauthManager(metaclass=ABCMeta):
    ...
    @property
    def is_access_token_setis_access_token_set (self):
        return self.access_token is not None

    @property
    def is_authorizedis_authorized (self):
        return self.is_access_token_set and self.access_token is not None and self.openid is not None

    @abstractmethod
    def get_authorization_urlget_authorization_url (self, nexturl='/'):
        pass
    ...
    def do_getdo_get (self, url, params, headers=None):
    ...
    def get_config(self):
        value = OAuthConfig.objects.filterfilter (typetype =self.ICON_NAME)
